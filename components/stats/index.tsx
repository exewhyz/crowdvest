...
import { Users, DollarSign, Award, Home } from "lucide-react";
  ...
  return (
    <section className="relative py-16 overflow-hidden" id="stats">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center text-white">
          {[
            {
